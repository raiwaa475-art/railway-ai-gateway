...
export const config = {
    ...
    deepseekInputCacheHitUsdPer1M: Number(process.env.DEEPSEEK_INPUT_CACHE_HIT_USD_PER_1M || 0.0028),
    deepseekInputCacheMissUsdPer1M: Number(process.env.DEEPSEEK_INPUT_CACHE_MISS_USD_PER_1M || 0.14),
    deepseekOutputUsdPer1M: Number(process.env.DEEPSEEK_OUTPUT_USD_PER_1M || 0.28),
